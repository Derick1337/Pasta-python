...
class Game:
    def __init__(self):
        ...
        px.image(2).load(0, 0, "Mapinha4.png")  # fase 4
         # Defina as posições iniciais para cada mapa
        self.map_positions = [
            (0, 0),  # fase 1
            (250, 0),  # fase 2 (ao lado da fase 1)
            (0, 250),  # fase 3 (abaixo da fase 1)
            (250, 250)  # fase 4 (ao lado e abaixo das fases 1 e 2)
        ]
