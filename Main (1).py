...
class LaunchScreen: # Classe para a tela inicial do jogo
    ...
    def update(self):
        if px.btnp(px.KEY_SPACE): # Se a tecla SPACE for pressionada, atualize a variável de controle
            self.show_initial_menu = True


    def draw(self):
        if self.show_initial_menu: # Se a variável de controle for True, mostre o menu inicial
            px.cls(0)
